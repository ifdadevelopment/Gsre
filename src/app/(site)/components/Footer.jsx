          ...
          <div className="flex md:gap-4 gap-2 md:text-lg text-xs">
            {[FaFacebookF, FaInstagram, FaLinkedinIn, FaTwitter].map((Icon, i) => (
              <Link
                key={i}
                href="#"
                className="w-8 h-8 flex items-center justify-center rounded-full bg-gray-800 hover:bg-white hover:text-gray-900 transition"
              >
                <Icon />
              </Link>
            ))}
        ...
        <div>
          ...
          <ul className="space-y-3 md:text-sm text-[12px]">
            <li className="md:ml-0 ml-[-8px]">
              <a href="tel:+919873159140" className="flex items-start gap-2 hover:text-white transition">
                <FaPhoneAlt className="md:text-sm text-[14px] mt-1" />
                <span className="text-xs md:text-sm">+91 9873159140</span>
              </a>
            </li>
            <li className="md:ml-0 ml-[-8px]">
              <a href="mailto:gsrefrigeration31@gmail.com" className="flex items-start gap-2 hover:text-white transition break-all">
            ...
            <li className="flex items-start gap-2 md:ml-0 ml-[-8px]">
              ...
              <span>T-787 Church Lane, Bhogal, New Delhi-110014</span>
            </li>
          </ul>
        </div>
      </div>
